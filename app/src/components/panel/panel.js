...
const Panel = () => {
    return (
        <div className="panel">
            ...
            <button className="uk-button uk-button-primary uk-margin-small-right" uk-toggle="target: #modal-open">Страницы</button>
            ...
            <button className="uk-button uk-button-default" uk-toggle="target: #modal-logout">Выход</button>
        </div>
    )
};
